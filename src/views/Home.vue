<template>
    <div class="wrapper" id="all" @mousewheel.prevent.stop>
        <div class="left">
        ...
        <div class="center">
            ...
            <div class="chartCenterTips">
                ...
                <div class="item">
                    <div class="num">{{isNaN((result.tjl/(allData.length*100)*100)) ? 0 : ((result.tjl/(allData.length*100)*100).toFixed(2))}}%</div>
                        ...
                        <table>
                            <tbody>
                                <tr v-for="(i, n) in allData" :key="n">
                                    ...
                                    <td>{{i.zl_num}}</td>
                                    <td>{{i.zytz_num}}</td>
                                    <td>{{parseFloat(i.tjl) > 100 ? 100 : parseFloat(i.tjl).toFixed(2)}}%</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="right">
            <div class="head"><div id="he-plugin-simple"></div></div>
...
const result = ref({})
onBeforeMount(() => {
    axios.get(`http://wthrcdn.etouch.cn/weather_mini?city=${userInfo.name}`)
    .then((response) => {
        weater.value = response.data.data.forecast[0]
    })
...
.chartCenterTips {
    position: relative;
    background-image: url('../../public/assets/img/centertopbg1.png');
...
.wrapper {
    ...
    background-image: url(../../public/assets/img/bg.gif);
    background-size: 100%;
    font-size: 1rem
        /* 16/16 */
    ;
...
.right {
    height: 100vh;
    .chartTop, .chartCenter, .chartBottom {
        background-image: url('../../public/assets/img/leftchartsbg.png');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: center center;
    }
...
.title {
    ...
    >div:first-child {
        width: 15rem;
        text-align: center;
        background-image: url('../../public/assets/img/charts-title.png');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: center center;
...
.center {
    ...
    .chartTop {
        background-image: url('../../public/assets/img/centertopbg3.png');
        background-repeat: no-repeat;
        background-size: 93% 100%;
        background-position: center center;
        padding-left: 4.0625rem /* 65/16 */;
...
.left {
    .head {
        // background-image: url('../../public/assets/img/left-top.png');
        // background-repeat: no-repeat;
        // background-size: 100% 100%;
        // background-position: center center;
        padding: 1.5625rem
...
.right {
    .head {
        // background-image: url('../../public/assets/img/right-top.png');
        // background-repeat: no-repeat;
        // background-size: 100% 100%;
        // background-position: center center;
        padding: 1.5625rem
...
.center .head {
    width: 100%;
    height: 8vh /* 122/16 */;
    line-height: 3.1125rem /* 85/16 */;
    margin: 0 auto;
    background-image: url('../../public/assets/img/centertopbg.png');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: center center;
}
...
.center .chartBottom {
    background-image: url('../../public/assets/img/center-bottom-bg.png')!important;
    width: 100%;
    height: 32.5vh;
    margin: 0 auto;
...
::-webkit-scrollbar-track {
    background-image: repeating-linear-gradient(45deg, red 0, red 1px, transparent 0, transparent 50%); background-size: 10px 10px;
}
